...
${KUBECTL} wait configuration.pkg configuration-azure-network --for=condition=Healthy --timeout 5m
${KUBECTL} wait configuration.pkg configuration-azure-network --for=condition=Installed --timeout 5m
